...
export function Education() {
  const education = [
    {
      ...
      institute: "City University, Dhaka",
      year: "2018 - 2022",
      result: "CGPA: 3.52 / 4.00"
    },
    {
      degree: "Higher Secondary Certificate (HSC)",
      institute: "Govt. Women's College, Barishal",
      year: "PASSED: 2017",
      result: "GPA: 4.17 / 5.00"
    },
    {
      degree: "Secondary School Certificate (SSC)",
      institute: "Niamati Adersha High School, Barishal Board",
      year: "PASSED: 2015",
      result: "GPA: 3.61 / 5.00"
    }
  ];

  const training = [
    {
      course: "Enterprise Systems Analysis & Design (ESAD) with C#",
  ...
  return (
    <section id="education" className="relative overflow-hidden bg-slate-50 dark:bg-[#020617] text-black dark:text-slate-100 transition-colors duration-300">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-12 relative z-10">
...
`;
fs.writeFileSync('c:/Users/USER/Documents/Portfolio/src/components/Education.tsx', code);
