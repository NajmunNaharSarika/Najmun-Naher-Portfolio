    ...
    <section id="contact" className="relative overflow-hidden bg-white dark:bg-[#020617] text-black dark:text-slate-100 transition-colors duration-300">
      ...
      <div className="pt-12 pb-24 relative overflow-hidden z-10">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-5xl sm:text-6xl font-black tracking-tighter uppercase mb-6 dark:text-white">
              Let's Talk
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-stretch">
            ...
            >
              <div>
                ...
                <div className="space-y-8">
                  <div className="group">
                    ...
                    <a href={\`mailto:\${personalInfo.contact.email}\`} className="text-lg font-medium group-hover:underline underline-offset-4 decoration-2 dark:text-slate-200">
              ...
              <div className="mt-12 pt-8 border-t border-black/10 dark:border-slate-800">
                <div className="flex flex-col sm:flex-row items-center justify-between w-full p-6 bg-slate-50 dark:bg-slate-900 border border-black/10 dark:border-slate-800 gap-4 transition-colors hover:border-black/30 dark:hover:border-rose-500/50">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="lg:col-span-7 bg-slate-50 dark:bg-slate-900 p-8 sm:p-12 border border-black/10 dark:border-slate-800 relative"
            >
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col h-full justify-between gap-12">
                  <div className="space-y-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                      <div className="group">
                        <label htmlFor="name" className="text-[10px] font-bold uppercase tracking-widest text-black/40 dark:text-slate-500 block mb-2 transition-colors group-focus-within:text-black dark:group-focus-within:text-rose-400">Full Name</label>
                        <input
                          type="text"
                          id="name"
                          name="name"
                          ...
                          required
                          className="w-full bg-transparent border-b border-black/20 dark:border-slate-700 py-3 text-lg focus:outline-none focus:border-black dark:focus:border-rose-500 transition-colors dark:text-white"
                          placeholder="Jane Doe"
                        />
                      </div>
                      <div className="group">
                        <label htmlFor="email" className="text-[10px] font-bold uppercase tracking-widest text-black/40 dark:text-slate-500 block mb-2 transition-colors group-focus-within:text-black dark:group-focus-within:text-rose-400">Email Address</label>
                        <input
                          type="email"
                          id="email"
                          name="email"
                    ...
                    <div className="group">
                      <label htmlFor="subject" className="text-[10px] font-bold uppercase tracking-widest text-black/40 dark:text-slate-500 block mb-2 transition-colors group-focus-within:text-black dark:group-focus-within:text-rose-400">Subject</label>
                      <input
                        type="text"
                        id="subject"
                        name="subject"
                    ...
                    <div className="group">
                      <label htmlFor="message" className="text-[10px] font-bold uppercase tracking-widest text-black/40 dark:text-slate-500 block mb-2 transition-colors group-focus-within:text-black dark:group-focus-within:text-rose-400">Message Details</label>
                      <textarea
                        id="message"
                        name="message"
                        ...
                        required
                        rows={4}
                        className="w-full bg-transparent border-b border-black/20 dark:border-slate-700 py-3 text-lg resize-none focus:outline-none focus:border-black dark:focus:border-rose-500 transition-colors dark:text-white"
...
`;
fs.writeFileSync('c:/Users/USER/Documents/Portfolio/src/components/Contact.tsx', code);
