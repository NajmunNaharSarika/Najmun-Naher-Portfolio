...
import { FiLayers, FiBox, FiCode } from "react-icons/fi";
...
const getIconForSkill = (name: string) => {
  ...
  if (lower.includes("azure")) return VscAzure;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            {categories.map((cat, idx) => (
              <m.div 
                ...
                className={`group ${idx === 3 ? "md:col-span-2 lg:col-span-2" : "lg:col-span-1"}`}
              >
                ...
                <ul className={`w-full ${idx === 3 ? "grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4" : "space-y-4"}`}>
