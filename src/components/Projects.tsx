      ...
      <div className="pt-12 pb-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mt-10">
            {filterOptions.map((opt) => (
              <button
                ...
                className={`px-3 py-2 sm:px-5 sm:py-2.5 rounded-none text-xs sm:text-sm font-bold uppercase tracking-widest border transition-all duration-300 ${
                  filter === opt.id
              ...
              >
                <div>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-black/60 dark:text-slate-400 line-clamp-3 mb-5 leading-relaxed font-light text-justify">
                      {project.description}
                    </p>
        ...
        <div className="mt-16 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 px-4 py-3 sm:px-8 sm:py-4 bg-transparent hover:bg-black dark:bg-slate-900 dark:hover:bg-slate-800 text-black hover:text-white dark:text-slate-200 border-2 border-black dark:border-slate-700 text-xs font-bold uppercase tracking-widest transition-all group w-full sm:w-auto"
          >
